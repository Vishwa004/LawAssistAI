...
<head>
    ...
    <title>Forgot Password - Law Assist AI</title>
...
<body class="relative h-screen w-screen flex items-center justify-center bg-cover bg-center"
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        <h2 class="text-2xl font-bold text-blue-600 text-center mb-4">Forgot Password</h2>

        <?php if (!empty($message)) : ?>
            <p class="text-center font-semibold text-red-600"><?= $message; ?></p>
        <?php endif; ?>

        <form action="../Backend/forgot_password_process.php" method="POST" class="space-y-4">
            <div>
        ...
        <a href="login_page.php" class="block text-center text-blue-500 font-semibold hover:underline mt-4">Back to Login</a>
    </div>
</body>
</html>